...
#         "Condition" : {
#           "StringEquals" : {
#             "oidc.eks.us-east-1.amazonaws.com/id/${split("/", aws_eks_cluster.main.identity[0].oidc[0].issuer[4])}"
#           }:aud" : "sts.amazonaws.com",
#           "oidc.eks.us-east-1.amazonaws.com/id/${split("/", aws_eks_cluster.main.identity[0].oidc[0].issuer[4])}"
#         }:sub" : "system : serviceaccount:default : backend"
#       }
#     }
#     }
#     ]
...
#           }:aud" : "sts.amazonaws.com",
#           "oidc.eks.us-east-1.amazonaws.com/id/${split("/", aws_eks_cluster.main.identity[0].oidc[0].issuer[4])}"
#         }:sub" : "system : serviceaccount:default : schema"
#       }
#     }
#     }
#     ]
